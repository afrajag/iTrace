...
final class SceneParserPlugins: Plugins {
    var pluginClasses: [String: SceneParser.Type]

    required init() {
        pluginClasses = [String: SceneParser.Type]()
    }

    func createInstance(_ name: String?) -> SceneParser? {
    ...
    @discardableResult
    func registerPlugin(_ name: String, _ pluginClass: SceneParser.Type) -> Bool {
