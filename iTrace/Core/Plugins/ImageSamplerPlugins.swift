...
final class ImageSamplerPlugins: Plugins {
    var pluginClasses: [String: ImageSampler.Type]

    required init() {
        pluginClasses = [String: ImageSampler.Type]()
    }

    func createInstance(_ name: String?) -> ImageSampler? {
    ...
    @discardableResult
    func registerPlugin(_ name: String, _ pluginClass: ImageSampler.Type) -> Bool {
