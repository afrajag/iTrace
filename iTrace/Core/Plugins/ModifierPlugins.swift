...
final class ModifierPlugins: Plugins {
    var pluginClasses: [String: Modifier.Type]

    required init() {
        pluginClasses = [String: Modifier.Type]()
    }

    func createInstance(_ name: String?) -> Modifier? {
        if name == "none" {
            return nil
        }
    ...
    @discardableResult
    func registerPlugin(_ name: String, _ pluginClass: Modifier.Type) -> Bool {
