...
final class FilterPlugins: Plugins {
    var pluginClasses: [String: Filter.Type]

    required init() {
        pluginClasses = [String: Filter.Type]()
    }

    func createInstance(_ name: String?) -> Filter? {
    ...
    @discardableResult
    func registerPlugin(_ name: String, _ pluginClass: Filter.Type) -> Bool {
