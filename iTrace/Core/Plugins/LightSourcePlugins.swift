...
final class LightSourcePlugins: Plugins {
    var pluginClasses: [String: LightSource.Type]

    required init() {
        pluginClasses = [String: LightSource.Type]()
    }

    func createInstance(_ name: String?) -> LightSource? {
    ...
    @discardableResult
    func registerPlugin(_ name: String, _ pluginClass: LightSource.Type) -> Bool {
