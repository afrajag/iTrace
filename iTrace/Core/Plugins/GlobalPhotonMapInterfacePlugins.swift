...
final class GlobalPhotonMapInterfacePlugins: Plugins {
    var pluginClasses: [String: GlobalPhotonMapInterface.Type]

    required init() {
        pluginClasses = [String: GlobalPhotonMapInterface.Type]()
    }

    func createInstance(_ name: String?) -> GlobalPhotonMapInterface? {
    ...
    @discardableResult
    func registerPlugin(_ name: String, _ pluginClass: GlobalPhotonMapInterface.Type) -> Bool {
