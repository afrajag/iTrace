...
final class BucketOrderPlugins: Plugins {
    var pluginClasses: [String: BucketOrder.Type]

    required init() {
        pluginClasses = [String: BucketOrder.Type]()
    }

    func createInstance(_ name: String?) -> BucketOrder? {
    ...
    @discardableResult
    func registerPlugin(_ name: String, _ pluginClass: BucketOrder.Type) -> Bool {
