...
final class CausticPhotonMapInterfacePlugins: Plugins {
    var pluginClasses: [String: CausticPhotonMapInterface.Type]

    required init() {
        pluginClasses = [String: CausticPhotonMapInterface.Type]()
    }

    func createInstance(_ name: String?) -> CausticPhotonMapInterface? {
    ...
    @discardableResult
    func registerPlugin(_ name: String, _ pluginClass: CausticPhotonMapInterface.Type) -> Bool {
