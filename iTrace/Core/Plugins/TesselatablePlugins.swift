...
final class TesselatablePlugins: Plugins {
    var pluginClasses: [String: Tesselatable.Type]

    required init() {
        pluginClasses = [String: Tesselatable.Type]()
    }

    func createInstance(_ name: String?) -> Tesselatable? {
    ...
    @discardableResult
    func registerPlugin(_ name: String, _ pluginClass: Tesselatable.Type) -> Bool {
