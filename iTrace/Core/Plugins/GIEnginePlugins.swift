...
final class GIEnginePlugins: Plugins {
    var pluginClasses: [String: GIEngine.Type]

    required init() {
        pluginClasses = [String: GIEngine.Type]()
    }

    func createInstance(_ name: String?) -> GIEngine? {
    ...
    @discardableResult
    func registerPlugin(_ name: String, _ pluginClass: GIEngine.Type) -> Bool {
