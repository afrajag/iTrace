...
final class BitmapReaderPlugins: Plugins {
    var pluginClasses: [String: BitmapReader.Type]

    required init() {
        pluginClasses = [String: BitmapReader.Type]()
    }

    func createInstance(_ name: String?) -> BitmapReader? {
    ...
    @discardableResult
    func registerPlugin(_ name: String, _ pluginClass: BitmapReader.Type) -> Bool {
