...
final class BitmapWriterPlugins: Plugins {
    var pluginClasses: [String: BitmapWriter.Type]

    required init() {
        pluginClasses = [String: BitmapWriter.Type]()
    }

    func createInstance(_ name: String?) -> BitmapWriter? {
    ...
    @discardableResult
    func registerPlugin(_ name: String, _ pluginClass: BitmapWriter.Type) -> Bool {
