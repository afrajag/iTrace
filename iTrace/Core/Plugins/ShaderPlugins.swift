...
final class ShaderPlugins: Plugins {
    var pluginClasses: [String: Shader.Type]

    required init() {
        pluginClasses = [String: Shader.Type]()
    }

    func createInstance(_ name: String?) -> Shader? {
    ...
    @discardableResult
    func registerPlugin(_ name: String, _ pluginClass: Shader.Type) -> Bool {
