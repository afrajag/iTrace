...
final class CameraLensPlugins: Plugins {
    var pluginClasses: [String: CameraLens.Type]

    required init() {
        pluginClasses = [String: CameraLens.Type]()
    }

    func createInstance(_ name: String?) -> CameraLens? {
    ...
    @discardableResult
    func registerPlugin(_ name: String, _ pluginClass: CameraLens.Type) -> Bool {
