...
//  iTrace
//
//  Created by Fabrizio Pezzola on 17/02/2020.
//  Copyright © 2020 Fabrizio Pezzola. All rights reserved.
//

public final class LinkedList<T> {
    /// Linked List's Node final class Declaration
    ...
    /// Typealiasing the node final class to increase readability of code
...
//: End of the base final class declarations & beginning of extensions' declarations:
// FIXME: - Extension to enable the standard conversion of a list to String
...
// FIXME: - Extension to add a 'reverse' function to the list
...
// FIXME: - An extension with an implementation of 'map' & 'filter' functions
extension LinkedList {
...
// FIXME: - Extension to enable initialization from an Array
extension LinkedList {
...
// FIXME: - Extension to enable initialization from an Array Literal
