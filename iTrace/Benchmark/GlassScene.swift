/*
final class GlassScene: SceneBuilder {
    func build() -> SceneParameter? {
        ...
        var mirrorSphere: SphereParameter! = SphereParameter()
        mirrorSphere.setName("mirror-sphere")
        mirrorSphere.setCenter(Point3(-30, 30, 20))
        mirrorSphere.setInstanceParameter(InstanceParameter().shaders("Mirror"))
        mirrorSphere.setRadius(20)
        mirrorSphere.setup(api)
        var glassSphere: SphereParameter! = SphereParameter()
        glassSphere.setName("glass-sphere")
        glassSphere.setCenter(Point3(28, 2, 20))
        glassSphere.setInstanceParameter(InstanceParameter().shaders("Glass"))
    ...
    func previewRender(_ api: SunflowAPI!) {
    ...
    func finalRender(_ api: SunflowAPI!) {
